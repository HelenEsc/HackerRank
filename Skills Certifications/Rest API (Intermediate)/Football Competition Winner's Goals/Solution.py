...
def getTotalGoalsByTeam(competition, team, year, which_team):
    current_page = 1
    total_pages = -1
    total_goals = 0
...
def getTotalGoals(competition, team, year):
    return getTotalGoalsByTeam(competition, team, year, "team1") + getTotalGoalsByTeam(competition, team, year, "team2")
